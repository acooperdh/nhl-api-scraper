...
def get_schedules(season: str, teams: DataFrame) -> DataFrame:
    ...
    schedule = schedule[['id', 'season', 'gameType', 'gameDate', 'startTimeUTC', 'gameState', 'awayTeam.abbrev', 'awayTeam.score', 'homeTeam.abbrev', 'homeTeam.score', 'gameOutcome.lastPeriodType']]
